...
- La programación para poder mostrar tweets consiste en:
  * tener el siguiente archivo declarado dentro del head <head><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></head>
    + http://platform.twitter.com/widgets.js
    + o igual el archivo lo encontramos en este repo (js/widgets.js)
